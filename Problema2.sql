...
BEGIN
    ...
    -- Inserção dos dados de stg_hospital_a.PACIENTE
    ...
    -- Inserção dos dados de stg_hospital_b.PACIENTE
    INSERT INTO stg_prontuario.PACIENTE (id, nome, dt_nascimento, cpf, nome_mae, dt_atualizacao)
    ...
    -- Inserção dos dados de stg_hospital_c.PACIENTE
    INSERT INTO stg_prontuario.PACIENTE (id, nome, dt_nascimento, cpf, nome_mae, dt_atualizacao)
    ...
    -- Log de sucesso
    SELECT 'Dados transferidos com sucesso!' AS log_message;
